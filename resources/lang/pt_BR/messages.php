...
return [
	...
	'controller-confirmation-already-exists'   => 'Já possuímos uma ativação para este pedido em nosso sistema!',
	'controller-confirmation-creation-success' => 'Pedido ativado com sucesso!',
	'controller-confirmation-creation-error'   => 'Erro ao salvar ativação no sistema!',
	'controller-confirmation-update-success'   => 'Ativação :id foi atualizada!',
	'controller-confirmation-update-error'     => 'Erro ao atualizar ativação :id!',
	'controller-confirmation-delete-success'   => 'Ativação :id deletada com sucesso!',
	'controller-confirmation-delete-error'     => 'Erro ao deletar ativação :id!',
	'controller-confirmation-restore-success'  => 'Ativação :id restaurada com sucesso!',
	'controller-confirmation-restore-error'    => 'Erro restaurando ativação :id!',
	...
	'model-server-uploaded-updating-error' => 'Erro ao marcar ativação como enviada aos servidores!.',
	'model-server-sync-error'              => 'Erro sincronizando servidor: :message',

	'model-steam-orders-cannot-generate-confirmation' => 'Seu pedido deve ter um token válido associado para poder ser ativado!',

	'time.days'    => 'dia|dias',
	'time.hours'   => 'hora|horas',
	'time.minutes' => 'minuto|minutos',

	'confirmation-form'            => 'Formulário da ativação',
	'confirmation-show-trashed'    => 'Mostrar ativações deletadas',
	'confirmation-public-id '      => 'Identificação pública da ativação',
	'confirmation-starting-period' => 'Período de início',
	'confirmation-ending-period'   => 'Período de término',
	'confirmation-highlight-from'  => 'Destacar ativações do usuário :user',
	'confirmation-create'          => 'Ativar',
	...
	'steam-order-step-4'           => 'Ativar pedido',
	...
	'token-order-step-3' => 'Gerar ativação',
	...
	'confirmation-count'  => 'Quantidade de ativações',
