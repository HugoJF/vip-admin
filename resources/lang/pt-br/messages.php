...
return [
    ...
    'user-settings-email-help'     => 'Utilizaremos esse email para enviar notificacoes de todos acontecimentos dentro da sua conta no VIP-Admin. <strong>(recomendado)</strong>',
