...
class ServerForm extends Form
{
    public function buildForm()
    {
        $this
            ->add('name', 'text', [
                'label'      => __('messages.form-server-name'),
                'rules'      => ['required'],
                'help_block' => [
